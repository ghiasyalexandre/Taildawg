...
const Home = () => {
  return (
    <>
      <section>
        <div className="container px-6 py-16 lg:py-16 mx-auto">
          <div className="items-center lg:flex">
            <div className="w-full lg:w-1/2 px-8">
              ...
              <div className="lg:max-w-lg">
                ...
                <p className="mt-3 px-0 sm:px-8 md:px-0 lg:px-0 text-gray-600 dark:text-gray-300 text-center lg:text-left text-sm sm:text-base lg:text-lg">
                ...
                <div className="w-full flex lg:inline-block justify-center">
                  <Link to="/about" draggable={false}>
                    <button className="w-full shadow-lg shadow-black/50 mr-2 py-2 lg:mx-0 mt-6 text-sm tracking-wider text-white uppercase transition-colors duration-300 transform bg-red-600 rounded-lg lg:w-auto hover:bg-red-500 focus:outline-none  focus:bg-red-500">
                      About Us
                    </button>
                  </Link>
                  <Link to="/order" draggable={false}>
                    <button className="w-full shadow-lg shadow-black/50  ml-2 py-2 lg:ml-4 mt-6 text-sm tracking-wider text-white uppercase transition-colors duration-300 transform bg-red-600 rounded-lg lg:w-auto hover:bg-red-500 focus:outline-none focus:bg-red-500">
                      Shop Now
                    </button>
                  </Link>
                </div>
      ...
      <section className="">
        <div className="container px-2 pb-48 mx-auto">
          ...
          <div className="grid xs:grid-cols-2 md:grid-cols-4 grid-cols-1 gap-8 xs:gap-y-40">
            <div className="relative h-[277px] group w-full rounded-3xl">
              ...
              <h2 className="mt-4 text-xl font-semibold capitalize text-red-500">
                Custom Top Tiki
              </h2>
